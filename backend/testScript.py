...
tp = fc.RunFilterOutput2DArray('goeree.xyz', './', 52630.5, 427706.0885167464,52590.5, 427698.9114832536, 52705.5, 427288.0885167464,52665.5, 427280.9114832536, startingPoints)

print("starting algo")
imgArr = algo.algorithm(tp[0], 8, tp[1][0])
